...
if strategy_choice == "營收動能型 (基本面優先)":
    ...
    <div class="logic-grid">
        ...
        <div class="logic-item"><div class="logic-index">06 / MOMENTUM</div><div class="logic-subtitle">創高動能</div><div class="logic-desc">近 6 個月內至少有單月營收創下 <span class="highlight-red">歷史新高</span>。</div></div>
    ...
    logic_html = """
    <div class="logic-grid">
        <div class="logic-item"><div class="logic-index">01 / SCOPE</div><div class="logic-subtitle">選股範圍</div><div class="logic-desc">全體上市櫃，嚴格排除 <span class="highlight-red">ETF、ETN、權證</span> 等非普通股。</div></div>
    ...
    logic_html = """
    <div class="logic-grid">
        <div class="logic-item"><div class="logic-index">01 / INTERSECTION</div><div class="logic-subtitle">雙引擎交集</div><div class="logic-desc">系統自動比對，抓出同時具備 <span class="highlight-red">營收創高動能</span> 與 <span class="highlight-red">技術面強勢</span> 的極致精選標的。</div></div>
...
if not st.session_state['scan_completed']:
    ...
    if "雙吻合" in strategy_choice: sample_text = "極致交集比對"
