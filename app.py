...
st.markdown("""
    ...
    .logic-item { background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(0, 242, 255, 0.15); border-radius: 14px; padding: 24px; transition: all 0.4s ease; }
...
st.markdown('<div class="update-note">🕒 每日 19:00 定時更新資料庫</div>', unsafe_allow_html=True)
st.markdown("---")
...
if not st.session_state['scan_completed']:
    ...
    <div class="logic-grid">
        <div class="logic-item"><div class="logic-index">01 / SCOPE</div><div class="logic-title">產業範圍</div><div class="logic-desc">鎖定上市櫃全體<span class="highlight">電子產業</span>標的。</div></div>
        <div class="logic-item"><div class="logic-index">02 / LIQUIDITY</div><div class="logic-title">流動性</div><div class="logic-desc">近 20 日日均成交量大於 <span class="highlight">1,000張</span>。</div></div>
        <div class="logic-item"><div class="logic-index">03 / LEVEL</div><div class="logic-title">技術位階</div><div class="logic-desc">現價需站穩長線生命線 <span class="highlight">MA240</span> 之上。</div></div>
        <div class="logic-item"><div class="logic-index">04 / TREND</div><div class="logic-title">趨勢排列</div><div class="logic-desc"><span class="highlight">MA60 > MA240</span>，確保多頭排列發散。</div></div>
        <div class="logic-item"><div class="logic-index">05 / SCALE</div><div class="logic-title">營收規模</div><div class="logic-desc">12 個月累積營收 (<span class="highlight">LTM</span>) 創下 5 年來新高。</div></div>
        <div class="logic-item"><div class="logic-index">06 / MOMENTUM</div><div class="logic-title">爆發動能</div><div class="logic-desc">近 6 個月內至少有單月營收創下 <span class="highlight">歷史新高</span>。</div></div>
        <div class="logic-item"><div class="logic-index">07 / DYNAMICS</div><div class="logic-title">季度動能</div><div class="logic-desc">確保 <span class="highlight">季 YoY > 0</span>，營運動能持續。</div></div>
        <div class="logic-item"><div class="logic-index">08 / TRACKING</div><div class="logic-title">相對強弱</div><div class="logic-desc">同步法人籌碼數據並執行還原權值 <span class="highlight">0050</span> 對標。</div></div>
    </div>
    """
    ...
    with btn_col:
        if st.button("🚀 啟動全量量化掃描系統", type="primary", use_container_width=True):
            p_bar = st.progress(0, text="📡 正在初始化...")
            with st.status("正在執行深度分析...", expanded=True) as status:
                steps = [(15, "🔍 正在過濾電子產業標的..."), (35, "📈 正在計算均線位階排列..."), (55, "🏭 正在檢索營收歷史數據..."), (75, "👥 正在同步三大法人籌碼..."), (90, "⚖️ 正在執行績效對標..."), (100, "🏆 正在產出報告...")]
                for p, txt in steps:
                    time.sleep(2.5); p_bar.progress(p, text=txt); status.write(txt)
                try:
    ...
    st.sidebar.download_button("📥 下載 Excel 報告", output.getvalue(), file_name=f"Quant_Report.xlsx")
