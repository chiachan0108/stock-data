...
st.markdown("""
    ...
    .status-pill {
        ...
        font-size: 0.8rem; color: #00f2ff; margin-bottom: 10px; margin-top: 15px;
    }
    .pulse-dot {
    ...
    .config-container {
        ...
        border-radius: 20px; padding: clamp(18px, 4vw, 25px); margin-top: 5px; margin-bottom: 30px; 
